...
public class RailSplineIntersection : RailSpline {
	RailSplineExit Bottom, TopLeft, TopRight;

	public RailSpline ExitRailTopLeft;
	public bool ExitRailTopLeftToIntersection;
	public RailSpline ExitRailTopRight;
